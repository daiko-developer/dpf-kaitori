...
if(isset($_POST['submit'])){
  ...
  if(count($errors) === 0){
    ...
    header('Location:http://' . $_SERVER['HTTP_HOST'] . dirname($_SERVER['PHP_SELF']) . '/purchase_confirm.php');
  }else{
    // エラー配列があればエラーを表示
    echo $errors['name'];
...
<body>
  <div id="wrapper" class="wrapper under purchase_form">
    ...
    <main id="main" class="main">
      ...
      <section class="areas">
        <div class="inner1500">
          <form id="purchase-form" class="form" method="POST" action="purchase_form.php" enctype="multipart/form-data">
            <div class="block">
