...
if(isset($_POST['submit'])){
  ...
  if(count($errors) === 0){
    ...
    header('Location:http://' . $_SERVER['HTTP_HOST'] . dirname($_SERVER['PHP_SELF']) . '/purchase_confirm');
  }else{
    // エラー配列があればエラーを表示
    echo $errors['name'];
                ...
                <li class="item03">
                  ...
                  <ul class="list04">
                    <li class="item04">
                      ...
                      <div class="data04">
                        <input id="purchase-form-type01" class="input" type="text" name="dpfType01" placeholder="FE82DG" value="<?php if (isset($dpfType01)) {echo $dpfType01;} ?>" required>
                      </div>
                    </li>
                    <li class="item04">
                      <div class="datattl04">
