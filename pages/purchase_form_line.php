...
if(isset($_POST['submit'])){
  ...
  if(count($errors) === 0){
    ...
    header('Location:http://' . $_SERVER['HTTP_HOST'] . dirname($_SERVER['PHP_SELF']) . '/purchase_confirm_line.php');
  }else{
    // エラー配列があればエラーを表示
    echo $errors['name'];
...
<head>
  ...
  <title>DPF買取申込|カンタンでどこよりも便利なDPFラクラク買取</title>
  <meta name="description" content="カンタンでどこよりも便利なDPFラクラク買取の買取申込ページです。">
  <meta name="keywords" content="DPF買取,ラクラク,便利,買取申込">
...
<body>
  <div id="wrapper" class="wrapper under purchase_form">
    ...
    <main id="main" class="main">
      ...
      <section class="areas">
        <div class="inner1500">
          <form id="purchase-form" class="form" method="POST" action="purchase_form_line.php" enctype="multipart/form-data">
            <div class="block">
