...
if($_SESSION['token'] === $_POST['token']){
  ...
  header('Location:http://' . $_SERVER['HTTP_HOST'] . dirname($_SERVER['PHP_SELF']) . '/contact_form.php');
}
?>
...
<head>
  ...
  <title>お問い合わせ完了|カンタンでどこよりも便利なDPFラクラク買取</title>
  <meta name="description" content="カンタンでどこよりも便利なDPFラクラク買取のお問い合わせ完了ページです。">
  <meta name="keywords" content="DPF買取,ラクラク,便利,お問い合わせ完了">
    ...
    <main id="main" class="main">
      <section class="area">
        <div class="inner">
          ...
          ?>
          <a href="contact_form.php">TOPに戻る</a>
        </div>
      </section>
    </main>
