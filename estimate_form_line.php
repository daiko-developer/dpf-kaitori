...
if(isset($_POST['submit'])){
  ...
  if(count($errors) === 0){
    ...
    header('Location:http://' . $_SERVER['HTTP_HOST'] . dirname($_SERVER['PHP_SELF']) . '/estimate_confirm_line.php');
  }else{
    // エラー配列があればエラーを表示
    echo $errors['name'];
...
<head>
  ...
  <title>DPF写真お見積り|カンタンでどこよりも便利なDPFラクラク買取</title>
  <meta name="description" content="カンタンでどこよりも便利なDPFラクラク買取のDPF写真お見積りページです。">
  <meta name="keywords" content="DPF買取,ラクラク,便利,DPF写真お見積り">
...
<body>
  <div id="wrapper" class="wrapper under estimate-form">
    ...
    <main id="main" class="main">
      ...
      <section class="areas">
        <div class="inner1500">
          <form id="estimate-form" class="form" method="POST" action="estimate_form_line.php" enctype="multipart/form-data">
            <div class="block">
