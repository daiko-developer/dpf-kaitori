...
<head>
  ...
  <title>DPFラクラク買取 | カンタンで便利！</title>
  <meta name="description" content="どこよりもカンタンで便利なDPFラクラク買取">
  <meta name="keywords" content="DPF買取,ラクラク,便利">
...
<body>
  <div id="wrapper" class="wrapper home">
    <!-- ヘッダー -->
    <!-- <script>header("./pages/common/");</script> -->
    ...
    <main id="main" class="main">
      <div class="homevisual">
        <div class="box box01">
          <div class="boxin inner1500">
            <div class="img01"><a href="#satei"><img class="img01-1" src="../images/home/home-slide-box01-txt03.png" alt="どこよりも早く！！０秒見積もり！！"><img class="img01-2" src="../images/home/home-slide-box01-txt03-hover.png" alt="どこよりも早く！！０秒見積もり！！今すぐ査定"></a></div>
            <div class="right">
              <div class="img02"><img src="../images/home/home-slide-box01-txt01.png" alt="どこよりもカンタン・便利なラクラク買取"></div>
              <div class="img03"><img src="../images/home/home-slide-box01-txt02.png" alt="古くても、汚れていても、壊れていてもOK"></div>
            </div>
          </div>
        </div>
        <div class="box box02">
          <div class="boxin inner1500">
            <div class="block-txt">
              <div class="txt01"><span class="maker"><img src="../images/home/home-slide-box02-txt.png" alt="FUSOキャンター触媒"></span><span class="txt03">買取強化中！</span></div>
              <div class="txt02">今なら！<span class="price01"><span class="price">80,000</span><span class="unit">円</span></span></div>
            </div>
            <div class="img"><img src="../images/home/home-slide-box02-img.png" alt="FUSOキャンター触媒"></div>
          </div>
        </div>
        <div class="box box02">
          <div class="boxin inner1500">
            <div class="block-txt">
              <div class="txt01"><span class="maker"><img src="../images/home/home-slide-box03-txt.png" alt="FUSOキャンター触媒"></span><span class="txt03">買取強化中！</span></div>
              <div class="txt02">今なら！<span class="price01"><span class="price">50,000</span><span class="unit">円</span></span></div>
            </div>
            <div class="img"><img src="../images/home/home-slide-box03-img.png" alt="FUSOキャンター触媒"></div>
          </div>
        </div>
        <div class="box box02">
          <div class="boxin inner1500">
            <div class="block-txt">
              <div class="txt01"><span class="maker"><img src="../images/home/home-slide-box04-txt.png" alt="FUSOキャンター触媒"></span><span class="txt03">買取強化中！</span></div>
              <div class="txt02">今なら！<span class="price01"><span class="price">80,000</span><span class="unit">円</span></span></div>
            </div>
            <div class="img"><img src="../images/home/home-slide-box04-img.png" alt="FUSOキャンター触媒"></div>
          </div>
        </div>
        <div class="box box03">
          <div class="boxin inner1500">
            <div class="txt">LINEでの<br>買取申込<br>見積りも<br>可能です</div>
            <div class="img"><img class="" src="../images/home/img04.png" alt="ラクラク買取LINE画面"></div>
          ...
          <ul class="list list-home-point">
            <li class="item item03">
              <div class="itemin inner1500">
                <div class="block-img"><img src="../images/home/img04.png" alt="LINEによる簡単見積り"></div>
                <div class="block-txt">
            ...
            <li class="item item01">
              <div class="itemin inner1500">
                <div class="block-img"><img src="../images/home/img02.png" alt="送料無料"></div>
                <div class="block-txt">
            ...
            <li class="item item02">
              <div class="itemin inner1500">
                <div class="block-img"><img src="../images/home/img03.png" alt="スピード入金"></div>
                <div class="block-txt">
              ...
              <ul class="list list-home-flow">
                <li class="item">
                  <div class="block-txt">
                    <h3 class="head">申込</h3>
                    <p class="txt">
                      <a href="purchase_form.php" class="link">買取申込フォーム</a>もしくは<a href="#line" class="link">LINE</a>の買取申込ページから申込を行ってください。<br><br>
                      ※個人のお客様は本人確認書類が初回お取引時に必要です。買取申込フォームで本人確認書類をアップロードしてください。<br>
                    </p>
                  </div>
                  <div class="img"><img class="" src="../images/home/img09.png" alt="書類準備"></div>
                </li>
                <li class="item">
                  <div class="block-txt">
                  ...
                  <div class="img"><img class="" src="../images/home/img10.png" alt="書類準備"></div>
                </li>
                <li class="item">
                  <div class="block-txt">
                    <h3 class="head">査定</h3>
                  ...
                  <div class="img"><img class="" src="../images/home/img11.png" alt="書類準備"></div>
                </li>
                <li class="item">
                  <div class="block-txt">
                  ...
                  <div class="img"><img class="" src="../images/home/img12.png" alt="書類準備"></div>
                </li>
              </ul>
            </div>
              ...
              <ul class="list list-home-flow">
                <li class="item">
                  <div class="block-txt">
                    ...
                    <div class="thumbnail"><a href="https://drive.google.com/uc?id=1reTXe9kV8KWHZH59qnJalvDE0r5h8UNi" target="_blank"><img src="../images/home/img13.jpg" alt="買取依頼書"></a></div>
                  </div>
                  <div class="img"><img class="" src="../images/home/img09.png" alt="書類準備"></div>
                </li>
                <li class="item">
        ...
        <div class="inner1500">
          ...
          <dl class="list-home06">
            ...
            <div class="item">
              ...
              <dd class="data">見積りは無料です。 見積りは<a href="estimate_form.php">こちら</a>から</dd>
            </div>
            <div class="item">
      ...
      <section id="satei" class="home-satei area">
        <div class="inner900">
          ...
          <div class="btn btn-cmn02 -estimate"><a href="estimate_form.php">写真お見積りはこちら</a></div>
        </div>
      </section>
      ...
      <section id="application" class="home-application area">
        <div class="inner1500">
          ...
          <div class="img"><img src="../images/home/img14.png" alt=""></div>
          <div class="btn btn-cmn02 -purchase"><a href="purchase_form.php">買取申込はこちら</a></div>
          <div id="line" class="line-contact area">
            <h3 class="ttl">スマホで完結！<br>LINEで買取・見積り申込も可能</h3>
            <div class="block">
              <div class="img"><img src="../images/home/line01.png" alt="ラクラク買取LINE画面"></div>
              <div class="friend-link">
                <div class="qr"><img src="https://qr-official.line.me/gs/M_969goccg_GW.png"></div>
                <a href="https://lin.ee/OiumxOV"><img src="https://scdn.line-apps.com/n/line_add_friends/btn/ja.png" alt="友だち追加" height="36" border="0"></a>
              </div>
    ...
    <!-- フッター -->
    <!-- <script>footer("./pages/common/");</script> -->
    <?php include 'pages/common/footer.php'; ?>
  </div>
  <!-- <script src="/js/satei.js"></script> -->
