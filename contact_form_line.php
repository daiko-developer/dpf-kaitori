...
if(isset($_POST['submit'])){
  ...
  if(count($errors) === 0){
    ...
    header('Location:http://' . $_SERVER['HTTP_HOST'] . dirname($_SERVER['PHP_SELF']) . '/contact_confirm_line.php');
  }else{
    // エラー配列があればエラーを表示
    echo $errors['name'];
  }
...
<body>
  <div id="wrapper" class="wrapper under contact-form">
    ...
    <main id="main" class="main">
      <h2 class="ttl-cmn01-line">お問い合わせ</h2>

      <section class="areas">
        <div class="inner1500">
          <form id="contact-form" class="form" method="POST" action="contact_form_line.php" enctype="multipart/form-data">
            <div class="block">
              <ul class="list01">
                <li class="item">
                  <ul class="list02">
