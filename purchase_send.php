...
if($_SESSION['token'] === $_POST['token']){
  ...
  header('Location:http://' . $_SERVER['HTTP_HOST'] . dirname($_SERVER['PHP_SELF']) . '/purchase_form.php');
}
?>
...
<head>
  ...
  <title>DPF買取申込み完了|カンタンでどこよりも便利なDPFラクラク買取</title>
  <meta name="description" content="カンタンでどこよりも便利なDPFラクラク買取のDPF買取申込み完了ページです。">
  <meta name="keywords" content="DPF買取,ラクラク,便利,買取申込み完了">
    ...
    <main id="main" class="main">
      <section class="area">
        <div class="inner">
          ...
          ?>
          <a href="purchase_form.php">TOPに戻る</a>
        </div>
      </section>
    </main>
