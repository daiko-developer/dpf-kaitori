...
if($_SESSION['token'] === $_POST['token']){
  ...
  header('Location:http://' . $_SERVER['HTTP_HOST'] . dirname($_SERVER['PHP_SELF']) . '/estimate_form.php');
}
?>
...
<head>
  ...
  <title>DPF写真お見積り完了|カンタンでどこよりも便利なDPFラクラク買取</title>
    ...
    <main id="main" class="main">
      <section class="area">
        <div class="inner">
          ...
          ?>
          <a href="estimate_form.php">TOPに戻る</a>
        </div>
      </section>
    </main>
